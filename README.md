...
[*] It is common to think of all IO devices as files. A file is an abstraction. An abstraction is something that lets a set of different things be treated in the same way.
